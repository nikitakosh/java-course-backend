...
public class Keys {
    ...
    public static final UniqueKey<ChatLinkRecord> CONSTRAINT_868 = Internal.createUniqueKey(ChatLink.CHAT_LINK, DSL.name("CONSTRAINT_868"), new TableField[]{ChatLink.CHAT_LINK.LINK_ID, ChatLink.CHAT_LINK.CHAT_ID}, true);
    ...
    public static final ForeignKey<ChatLinkRecord, LinkRecord> CONSTRAINT_8 = Internal.createForeignKey(ChatLink.CHAT_LINK, DSL.name("CONSTRAINT_8"), new TableField[]{ChatLink.CHAT_LINK.LINK_ID}, Keys.CONSTRAINT_2, new TableField[]{Link.LINK.ID}, true);
